        ...
        <div class="Top">
            ...
            <ul class="Register">
                ...
                <li class="Registermenu1">
                   ...
                   echo '<a href="signout.php" style="font-family: serif; font-size:1.5vw;"><b>Log Out</b>&nbsp;<i class="fas fa-sign-in-alt"></i></a>';}else{ echo'<a href="signin.php" style="font-family:serif; font-size:1.5vw;"><b>Log In</b>&nbsp;<i class="fas fa-sign-in-alt"></i></a>';} ?>
                        </li>
                ...
                <li class="Registermenu3"><a href="Profile.php" style="font-family:serif; font-size:1.5vw;"><p><b>
                            ...
                            if(isset($_SESSION['img'])){
                                echo'<div style="width:20%; margin-top: -20px; height:40px; border-radius:50%; transition-property: scale (.2)"><img style="border-radius: 50%;" src="images/'.$_SESSION['img'].'"width="100%" height="40px" />
                            </div>';}else{ echo'<p style="margin-top:-20px;"><i class="fas fa-user-tie"></i></p>&nbsp;';} 
                    if(isset($_SESSION['name'])){'<p style="margin-top: -40px; margin-left: 25%;">'.$_SESSION['name'].'</p>
                         ';}else{ echo '<p style="margin-left: 13%; margin-top: -75px;"> My Profile</p>';}
                         ?>
                        </b></p></a></li>
            </ul> 
            </div>
