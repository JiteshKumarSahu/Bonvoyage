        ...
        <div class="content">
            ...
            <div class="xplorepic">
                ...
                while ($row = mysqli_fetch_array($sql)) {
                    echo '<div class="imagesxplore"><div class="imgxplore"><img style="width:100%; height:200px;" src="images/'.$row["url"].' "/><h2 style="color:white;"> '.$row["name"].' <a href="Tourbook.php?type=xplore&id= '.$row["id"].' "><input type="submit"  name="booknow" value="booknow" style="width:35%; height:30px; background-color: red; float:right; color:white;"></a></h2></div><div class="detailxplorepic" style="color:white;"><br> '.$row["desc"].'</div></div>';} ?> 
            ...
            <div class="luxorypic">
                ...
                while ($row = mysqli_fetch_array($sql)) {
                    echo '<div class="imagesLuxory"><div class="imgluxory"><img style="width:100%; height:200px;" src="images/'.$row['url'].'"/> <h2 style="color:white;">'.$row["name"].'<a href="Tourbook.php?type=luxury&id='.$row["id"].'"><input type="submit"  name="booknow" value="booknow" style="width:35%; height:30px; background-color: red; float:right; color:white;"></a></h2></div><br><br>
